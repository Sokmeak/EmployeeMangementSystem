...
class PieChartService extends JPanel {
  ...
  public PieChartService(double females, double males) {
  ...
  public static void CreatePieChart(double fe, double ma) {
    PieChartService ps = new PieChartService(fe, ma);
    ps.isVisible();
  }
