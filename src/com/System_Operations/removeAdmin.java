...
public class removeAdmin extends JPanel {

  private JPanel subpAddLb = new JPanel();
  private JPanel subpAddTf = new JPanel();
  private JLabel addLabel = new JLabel();

  private JButton removeAdmin = new JButton("Remove");
  ...
  public removeAdmin() {
    ...
    removeAdmin.setBounds(140, 430, 150, 40);
    removeAdmin.setBackground(Color.PINK);
    removeAdmin.setFont(myFont());
    removeAdmin.addActionListener(new MyClickListener());
    add(removeAdmin);
  ...
  public class MyClickListener implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
      if (e.getSource() == removeAdmin) {
        ...
        fileSerive.deleteAdmin(us, pas, fileSerive.filename);
